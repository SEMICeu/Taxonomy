...
Jaro-Winkler resulted better than other string distances available in Sparql-Anything in finding closest matches, see [string_distance_comparison.csv](string_distance_comparison.csv), generating only 2 false positives out of 117 results.  
