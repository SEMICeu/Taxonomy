...
The example below shows how the code [JLR3](https://github.com/SEMICeu/Taxonomy/blob/master/Entity_Legal_Form/2023-09-28-elf-code-list-v1.5.csv#L111-L112) in multiple languages with transliteration is transformed. In particular, it is possible to see how the skos-xl:labels allow associate the labels with the respective abbreviations.
